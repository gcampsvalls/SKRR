function [Ypred, BestSigma1, BestSigma2, BestLambda1, BestLambda2] = trainSKRRclassrbf(Xtrain,Ytrain,Xvalid,Yvalid,Xtest)
    ...
    for sigma2 = SIGMAS2
        ...
        for lambda1 = LAMBDAS1
            for lambda2 = LAMBDAS2
                ...
                RESULTS(i,:) = [sigma1 sigma2 lambda1 lambda2 res.Kappa];
            end
        end
    end
end
